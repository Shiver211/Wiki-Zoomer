...
public class ExportTask {
    ...
    private ExportTask(Type type, ItemStack itemStack, @Nullable Entity entity, @Nullable ResourceLocation entityId, File outputFile, Background background, boolean isBatch, float zoomPercent, int exportSize) {
        this.type = type;
