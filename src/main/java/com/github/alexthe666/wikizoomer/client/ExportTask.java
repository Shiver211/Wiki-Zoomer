...
public class ExportTask {
    ...
    private ExportTask(Type type, ItemStack itemStack, @Nullable Entity entity, @Nullable ResourceLocation entityId, File outputFile, Background background, boolean isBatch, float zoomPercent, int exportSize, float rotX, float rotY, float offsetX, float offsetY) {
        this.type = type;
    ...
    public static ExportTask forEntity(Entity entity, File outputFile, Background background, boolean isBatch, float zoomPercent, int exportSize, float rotX, float rotY, float offsetX, float offsetY) {
    ...
    public static ExportTask forEntityId(ResourceLocation entityId, File outputFile, Background background, boolean isBatch, float zoomPercent, int exportSize, float rotX, float rotY, float offsetX, float offsetY) {
